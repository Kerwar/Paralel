  ...
  subroutine set_coef(this, param, nx, ny)
    ...
    elseif (nx > param%mx2) then
      ...
      subroutine coefx_2(point, param)
        ...
        point%sT = param%q * point%Z * param%hx * param%hy
        point%sF = 8.0_DP/3.0_DP * point%gammaFw - param%hy * param%m * point%v(1) 
        point%sZ = 0.0_DP
      ...
      subroutine coefx_5(point, param)
        ...
        point%sT = param%q * point%Z * param%hx * param%hy
        point%sF = 8.0_DP/3.0_DP * point%gammaFe - param%hy * param%m * point%v(1)
        point%sZ = 0.0_DP
      ...
      subroutine coefy_2(point, param)
        ...
        point%aF(5) = point%aF(5) + ap + &
        param%xy * (point%gammaFs + 3.0_DP * point%gammaFn)
        point%aZ(5) = point%aZ(5) + ap + &
        param%xy * (point%gammaZs + 3.0_DP * point%gammaZn)
      ...
      subroutine coefy_3(point, param)
        ...
        point%aF(5) = point%aF(5) + ap + &
        param%xy * (3.0_DP * point%gammaFs + point%gammaFn)
        point%aZ(5) = point%aZ(5) + ap + &
        param%xy * (3.0_DP * point%gammaZs + point%gammaZn)
