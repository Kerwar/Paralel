...
contains
  ...
  subroutine set_coef(this, param, nx, ny)
    ...
    if (associated(this%setXc, coefx_3) .or. associated(this%setXc, coefx_4) .or. associated(this%setXc, coefx_66)) then
      this%setYc => coefy_5
    end if
  end subroutine
  ...
  !Terrible Inlet
  subroutine coefx_66(point, param)
    class(point_t), intent(inout) :: point
    type(param_t), intent(in) :: param
  ...
  subroutine coefy_4(point, param)
    ...
    point%aT(5) = point%aT(5) + 2.0_DP*param%a2*param%xy
    point%aF(5) = 1.0_DP
    point%aZ(5) = 1.0_DP
  ...
  subroutine coefy_8(point, param)
    ...
    point%aT(5) = point%aT(5) + 2.0_DP*ap + &
                  param%xy*(point%gammaTy)
    point%aF(5) = point%aF(5) + 2.0_DP*ap + &
                  param%xy*(point%gammaFy)
    point%aZ(5) = point%aZ(5) + 2.0_DP*ap + &
                  param%xy*(point%gammaZy)
  ...
  subroutine coefy_9(point, param)
    ...
    point%aT(4) = 2.0_DP*an - param%xy*point%gammaTy
    point%aF(4) = 2.0_DP*an - param%xy*point%gammaFy
    point%aZ(4) = 2.0_DP*an - param%xy*point%gammaZy
  ...
  subroutine coefy_11(point, param)
    ...
    point%aT(5) = point%aT(5) + param%a2*param%xy
    point%aF(5) = 1.0_DP
    point%aZ(5) = 1.0_DP
